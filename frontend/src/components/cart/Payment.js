        ...
        try {
            ...
            if (result.error) {
                ...
                if (result.paymentIntent.status === 'succeeded') {
                    ...
                    throw new Error('API response is invalid or missing data');
                }
            }
    ...
    <div className="row wrapper">
        <div className="col-10 col-lg-5">
            <form className="shadow-lg" onSubmitCapture={submitHandler}>
                ...
                >
                      Proceed to Pay - {orderInfo && orderInfo.totalPrice ? `₹ ${orderInfo.totalPrice}` : ''}
                    {/* Proceed to Pay - {`  ₹ ${orderInfo && orderInfo.totalPrice}`} */}
                </button>
